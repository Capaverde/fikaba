...
const SQLUSER = 'root';				//MySQL user (must be changed)
const SQLPASS = '9d6ha5o4';			//MySQL user's password (must be changed)
const SQLDB = 'test';				//Database used by image board
...
const BUMPLIMIT = 500;				//Maximum topic bumps
